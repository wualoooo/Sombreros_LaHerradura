...
function subirImagen($clave_archivo, $carpeta_destino) {
    if (isset($_FILES[$clave_archivo]) && $_FILES[$clave_archivo]['error'] == 0) {
        ...
        $nuevo_nombre = uniqid('ImgCinturon_') . '.' . $extension;
...
$Img1_nombre_db = subirImagen('imgCinturon1', $carpeta_destino);
$Img2_nombre_db = subirImagen('imgCinturon2', $carpeta_destino);
$Img3_nombre_db = subirImagen('imgCinturon3', $carpeta_destino);
$Img4_nombre_db = subirImagen('imgCinturon4', $carpeta_destino);

$sql = "INSERT INTO cinturones (Nombre, Precio, Material, Adorno, Tamaño, Img1, Img2, Img3, Img4) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
$insert = $conn->prepare($sql);

$insert->bind_param(
    "sssssssss",
    $Nombre, $Precio, $Material, $Adorno, $Tamaño, $Img1_nombre_db,  $Img2_nombre_db, $Img3_nombre_db,  $Img4_nombre_db);
