...
$sql = $conn->prepare("SELECT * FROM texana WHERE id_texana = ?");
...
if ($result->num_rows === 0) {
    ...
    echo json_encode(['error' => 'Consulta vacía. No se encontró ningún producto con el ID: ' . $id_texana]);
    exit;
}
