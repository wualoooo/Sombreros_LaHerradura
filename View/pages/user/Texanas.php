    ...
    <div class="container">
        ...
        <div class="item" id="Filtros">
            <div class="item" id="Filtros2">
                ...
                <div class="grupo-filtro">
                    <input type="text" id="filtro-nombre" class="filtro-input" placeholder="Buscar texana...">
                </div>
                ...
                <div class="grupo-filtro">
                    <h4>Color</h4>
                    <div class="checkbox-list" id="filtro-color">
                        <?php 
                            $resulthormas = $conn->query("SELECT id_color, Nombre FROM colores WHERE Producto = 'Texanas'");
                            while ($row = $resulthormas->fetch_assoc()) echo "<label><input type='checkbox' class='check-color' value='".$row['id_color']."'>".$row['Nombre']."</label> ";
                        ?>
                    </div>
                </div>
        ...
        <div class="item" id="Productos">
            <div class="container2">
                <?php 
                    $sql = "SELECT id_texana, Img1, Nombre, Precio FROM texanas WHERE Estado = 1";
                    $result = $conn->query($sql);
                    while ($row = $result -> fetch_assoc()){
                        echo("
                            <div class='card abrir-modal-vp' data-id='" . $row["id_texana"] . "'>
                                <div class='img-producto'>
                                    <img src='/LaHerradura/uploads/texanas/".$row["Img1"]."' alt='".$row["Nombre"]."'>
                                </div>
