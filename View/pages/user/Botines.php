...
<body>
        ...
        <div class="item" id="Filtros">
            <div class="item" id="Filtros2">
                ...
                <div class="grupo-filtro">
                    <input type="text" id="filtro-nombre" class="filtro-input" placeholder="Buscar botin...">
                </div>
                ...
                <div class="grupo-filtro">
                    <h4>Material</h4>
                    <div class="checkbox-list" id="filtro-materialBotin">
                        <?php 
                            $resulthormas = $conn->query("SELECT id_material, Nombre FROM materiales WHERE Producto = 'Botines'");
                            while ($row = $resulthormas->fetch_assoc()) echo "<label><input type='checkbox' class='check-material' value='".$row['id_material']."'>".$row['Nombre']."</label> ";
                        ?>
                    </div>
                </div>
                ...
                <div class="grupo-filtro">
                    <h4>Tipo de Suela</h4>
                    <div class="checkbox-list" id="filtro-suela">
                        <?php 
                            $resulthormas = $conn->query("SELECT id_material, Nombre FROM materiales WHERE Producto = 'Suelas'");
                            while ($row = $resulthormas->fetch_assoc()) echo "<label><input type='checkbox' class='check-suela' value='".$row['id_material']."'>".$row['Nombre']."</label> ";
                        ?>
                    </div>
                </div>
                ...
                <div class="grupo-filtro">
                    ...
                    <div class="checkbox-list" id="filtro-tallas">
                        <label><input type="checkbox" class="check-talla-botin" value="23"> Talla 23</label>
                        <label><input type="checkbox" class="check-talla-botin" value="24"> Talla 24</label>
                        <label><input type="checkbox" class="check-talla-botin" value="25"> Talla 25</label>
                        <label><input type="checkbox" class="check-talla-botin" value="26"> Talla 26</label>
                        <label><input type="checkbox" class="check-talla-botin" value="27"> Talla 27</label>
                        <label><input type="checkbox" class="check-talla-botin" value="28"> Talla 28</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container2">
                <?php 
                    ...
                    while ($row = $result -> fetch_assoc()){
                        echo("
                            <div class='card abrir-modal-vp' data-id='" . $row["id_botin"] . "'>
                                <div class='img-producto'>
                                    <img src='/LaHerradura/uploads/botines/".$row["Img1"]."' alt='".$row["Nombre"]."'>
                                </div>
    ...
    <script src="/LaHerradura/public/ViewProducts/viewBotines.js"></script>
</body>
</html>