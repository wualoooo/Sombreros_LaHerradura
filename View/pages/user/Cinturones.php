...
<body>
    ...
    <div class="container">
                        ...
                        echo("
                            ...
                            <div class='card abrir-modal-vp' data-id='" . $row["id_cinturon"] . "'>
                                <div class='img-producto'>
                                    <img src='/LaHerradura/uploads/cinturones/".$row["Img1"]."'>
                                </div>
        ...
        <?php 
        include(ROOT_PATH . 'View/modals/modal-ViewCinturones.php')
    ...
    <script src="/LaHerradura/public/viewCinturones.js"></script>
</body>
</html>