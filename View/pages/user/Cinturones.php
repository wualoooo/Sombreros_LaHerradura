...
<body>
        ...
        <div class="item" id="Filtros">
            <div class="item" id="Filtros2">
                ...
                <div class="grupo-filtro">
                    <input type="text" id="filtro-nombre" class="filtro-input" placeholder="Buscar cinturon...">
                </div>
                ...
                <div class="grupo-filtro">
                    <h4>Tipo de Adorno</h4>
                    <div class="checkbox-list" id="filtro-adorno">
                        <?php 
                            $resulthormas = $conn->query("SELECT id_material, Nombre FROM materiales WHERE Producto = 'Adornos'");
                            while ($row = $resulthormas->fetch_assoc()) echo "<label><input type='checkbox' class='check-adorno' value='".$row['id_material']."'>".$row['Nombre']."</label> ";
                        ?>
                    </div>
                </div>
                ...
                <div class="grupo-filtro">
                    <h4>Material</h4>
                    <div class="checkbox-list" id="filtro-material">
                        <?php 
                            $resulthormas = $conn->query("SELECT id_material, Nombre FROM materiales WHERE Producto = 'Cinturones'");
            ...
            <div class="container2">
                <?php 
                    ...
                    while ($row = $result -> fetch_assoc()){
                        echo("
                            <div class='card abrir-modal-vp' data-id='" . $row["id_cinturon"] . "'>
                                <div class='img-producto'>
                                    <img src='/LaHerradura/uploads/cinturones/".$row["Img1"]."' alt='".$row["Nombre"]."'>
                                </div>
    ...
    <script src="/LaHerradura/public/ViewProducts/viewCinturones.js"></script>
</body>
</html>